...
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/community-scripts/ProxmoxVE/profile_d_motd/misc/copy-data/home-assistant-core-copy-data-home-assistant-container.sh)"
